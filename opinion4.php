	  ...
	  <div class="main box-border">
                    <div id="mi-slider" class="mi-slider">
                        <ul>
                            ...
                            <li><a href="#">
                                <img src="assets/ItemSlider/images/9.jpg" alt="img01"><h4>Boots</h4>
                            </a></li>
                            <li><a href="#">
                                <img src="assets/ItemSlider/images/10.jpg" alt="img02"><h4>Oxfords</h4>
                            </a></li>
                            <li><a href="#">
                                <img src="assets/ItemSlider/images/11.jpg" alt="img03"><h4>Loafers</h4>
                            </a></li>
