    ...
    <div class="login_wrapper">
            ...
            <section class="login_content" style="margin-top: -40px;">
                <form name="form1" action="" method="POST">
                    <img src="images/symphony.jpg" width="350" >
...
if(isset($_POST["submit1"]))
{
  ...
  if ($conn->connect_error) {
   die("Connection failed: " . $conn->connect_error);
	 ...
	 $sql = "SELECT name, brand, ram, rom, processor, camera, warranty, price FROM product where brand='symphony' ";
  $result = $conn->query($sql);
  if ($result->num_rows > 0) {
   // output data of each row
   while($row = $result->fetch_assoc()) {
    echo "<div class='col-md-6'><li>" . $row["name"]. "</li><li>" . $row["brand"] . " </li><li>" . $row["ram"] . " </li><li>" . $row["rom"] . " </li><li>" . $row["processor"] . " </li><li>". $row["camera"] . " </li><li>" . $row["warranty"] . " </li><li>"
. $row["price"]. " </li></div>";
}
echo "</div>";
} else { echo "0 results"; }
